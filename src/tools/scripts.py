...
overview_home = f"\
- This app is the collaboration of a professional financial analyst melded with the skillset of a data scientist and the power of python programming. \
    This union combines tallent, knowledge, and industry experience to operate near-autonomously as an all in one Auto Advisor powered by Machine Learning\
    that remains unique to financial analysis."
...
financial_disclosure = "__[NOT INVESTMENT ADVICE]__ - The information in the Site constitutes professional and/or financial advice. \
